export const en: Record<string, string> = {
  ...
  'lang.en': 'English',
  'model.name': 'Note',
  'model.namePh': 'Shown in the model list',
  'model.apikey': 'API Key',
  'model.apikeyPh': 'sk-...',
  'model.apikeyKeep': 'Leave blank to keep the current key',
  'model.apibase': 'API base URL',
  'model.apibasePh': 'https://.../v1/messages',
  ...
  'model.model': 'Model',
  'model.modelPh': 'model parameter name',
  ...
  'model.aggregation': 'Channel group (auto failover)',
  'model.aggregationShort': 'Channel group',
  'model.aggregationDesc': 'Tries in order, switches to the next on failure',
  'model.emptyMixin': 'No models added yet',
  'model.addToMixin': 'Add to channel',
  'model.inMixin': 'In channel',
  'model.removeFromMixin': 'Remove from channel',
  'model.alreadyInMixin': 'Already in the channel',
  ...
  'pq.deepseekDesc': 'Official API · OpenAI-compatible',
  'pq.qwenDesc': 'Tongyi Qwen · Aliyun Bailian',

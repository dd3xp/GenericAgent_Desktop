export const zh: Record<string, string> = {
  ...
  'pq.toggle': '展开 / 收起',
  'pq.deepseekDesc': '官方 API · OpenAI 兼容',
  'pq.qwenDesc': '通义千问 · 阿里云百炼',

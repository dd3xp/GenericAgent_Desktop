(() => {
  ...
  zh: {
    ...
    'set.appearance': '外观', 'set.plainUi': '素色', 'set.fontSize': '聊天字号', 'set.lang': '语言', 'set.model': '模型', 'set.addModel': '添加模型', 'set.features': '功能', 'set.importMykey': '导入模型配置', 'set.exportMykey': '导出模型配置', 'set.importMemory': '导入记忆与会话记录', 'set.gaSource': '接入外部 GenericAgent 源码', 'set.gaSourceClear': '改用内置版本', 'set.gaSourceCurrent': '当前接入', 'set.serviceManager': '后台服务管理', 'set.openDataDir': '打开数据文件夹', 'set.selectDataDir': '选择数据目录', 'set.moveDataDir': '移动数据目录', 'set.dataDirClear': '恢复默认数据目录', 'set.dataDirCurrent': '当前数据目录', 'set.dataDirDefault': '默认',
    ...
    'set.openDataDirTip': '打开可写数据文件夹（报告 temp/ 与记忆 memory/ 所在），可直接取用或编辑',
    'set.selectDataDirTip': '选择以后使用的数据目录；不会自动搬迁当前数据',
    'set.moveDataDirTip': '把当前数据目录整体移动到所选位置下，并删除旧目录',
    'set.dataDirClearTip': '清除自定义数据目录，恢复默认 ~/GenericAgent_Data',
    ...
    'err.openDataDir': '打开数据文件夹失败',
    'err.dataDirSet': '设置数据目录失败',
    'err.dataDirMove': '移动数据目录失败',
    'err.dataDirDesktopOnly': '此功能仅在桌面版中可用',
    'sys.memoryImportBackup': '原记忆已备份至',
    'sys.memorySessions': '会话',
    'sys.dataDirPickTitle': '选择 GenericAgent 数据目录',
    'sys.dataDirMoveTitle': '选择新的 GenericAgent 数据目录位置',
    'sys.dataDirSwitching': '正在切换数据目录并重启后端...',
    'sys.dataDirMoving': '正在移动数据并切换目录...',
    'sys.dataDirSet': '已切换数据目录',
    'sys.dataDirMoved': '已移动并切换数据目录',
    'sys.dataDirCleared': '已恢复默认数据目录',
    'confirm.moveDataDirTitle': '移动数据目录？',
    'confirm.moveDataDir': '将当前数据目录整体移动到所选位置下，并删除旧目录。是否继续？',
    'confirm.dataDirClearTitle': '恢复默认数据目录？',
    'confirm.dataDirClear': '清除自定义数据目录后，后端会重启并使用默认 ~/GenericAgent_Data。旧目录不会删除。是否继续？',
  ...
  en: {
    ...
    'set.appearance': 'Appearance', 'set.plainUi': 'Plain', 'set.fontSize': 'Chat font size', 'set.lang': 'Language', 'set.model': 'Model', 'set.addModel': 'Add model', 'set.features': 'Features', 'set.importMykey': 'Import model config', 'set.exportMykey': 'Export model config', 'set.importMemory': 'Import memory and sessions', 'set.gaSource': 'Connect external GenericAgent source', 'set.gaSourceClear': 'Use bundled version', 'set.gaSourceCurrent': 'Connected to', 'set.serviceManager': 'Service manager', 'set.openDataDir': 'Open data folder', 'set.selectDataDir': 'Choose data folder', 'set.moveDataDir': 'Move data folder', 'set.dataDirClear': 'Restore default data folder', 'set.dataDirCurrent': 'Current data folder', 'set.dataDirDefault': 'default',
    ...
    'set.openDataDirTip': 'Open the writable data folder (holds reports under temp/ and memory/) to copy or edit files directly',
    'set.selectDataDirTip': 'Choose the data folder to use from now on; this does not move existing data',
    'set.moveDataDirTip': 'Move the current data folder under the selected location and delete the old folder',
    'set.dataDirClearTip': 'Clear the custom data folder and restore the default ~/GenericAgent_Data',
    ...
    'err.openDataDir': 'Failed to open data folder',
    'err.dataDirSet': 'Failed to set data folder',
    'err.dataDirMove': 'Failed to move data folder',
    'err.dataDirDesktopOnly': 'This feature is only available in the desktop app',
    'sys.memoryImportBackup': 'Previous memory backed up to',
    'sys.memorySessions': 'sessions',
    'sys.dataDirPickTitle': 'Choose GenericAgent data folder',
    'sys.dataDirMoveTitle': 'Choose the new GenericAgent data folder location',
    'sys.dataDirSwitching': 'Switching data folder and restarting backend...',
    'sys.dataDirMoving': 'Moving data and switching folder...',
    'sys.dataDirSet': 'Data folder switched',
    'sys.dataDirMoved': 'Data folder moved and switched',
    'sys.dataDirCleared': 'Default data folder restored',
    'confirm.moveDataDirTitle': 'Move data folder?',
    'confirm.moveDataDir': 'Move the current data folder under the selected location, switch to it, and delete the old folder. Continue?',
    'confirm.dataDirClearTitle': 'Restore default data folder?',
    'confirm.dataDirClear': 'The backend will restart and use the default ~/GenericAgent_Data. The old folder is not deleted. Continue?',

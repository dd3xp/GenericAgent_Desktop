(() => {
  ...
  zh: {
    ...
    'set.appearance': '外观', 'set.plainUi': '素色', 'set.fontSize': '聊天字号', 'set.lang': '语言', 'set.model': '模型', 'set.addModel': '添加模型', 'set.features': '功能', 'set.importMykey': '导入模型配置', 'set.exportMykey': '导出模型配置', 'set.importMemory': '导入记忆与会话记录', 'set.openTempDir': '打开输出文件夹', 'set.openMemoryDir': '打开记忆文件夹', 'set.openAssetsDir': '打开资产文件夹', 'set.openRuntimeDir': '打开运行目录', 'set.gaSource': '接入外部 GenericAgent 源码', 'set.gaSourceClear': '改用内置版本', 'set.gaSourceCurrent': '当前接入', 'set.serviceManager': '后台服务管理',
    ...
    'set.openTempDirTip': '打开 temp 目录，方便复制报告、模型响应和临时输出',
    'set.openMemoryDirTip': '打开 memory 目录，方便查看或编辑记忆文件',
    'set.openAssetsDirTip': '打开 assets 目录，方便查看运行资产和素材',
    'set.openRuntimeDirTip': '打开当前 GenericAgent 运行目录',
  ...
  en: {
    ...
    'set.appearance': 'Appearance', 'set.plainUi': 'Plain', 'set.fontSize': 'Chat font size', 'set.lang': 'Language', 'set.model': 'Model', 'set.addModel': 'Add model', 'set.features': 'Features', 'set.importMykey': 'Import model config', 'set.exportMykey': 'Export model config', 'set.importMemory': 'Import memory and sessions', 'set.openTempDir': 'Open output folder', 'set.openMemoryDir': 'Open memory folder', 'set.openAssetsDir': 'Open assets folder', 'set.openRuntimeDir': 'Open runtime folder', 'set.gaSource': 'Connect external GenericAgent source', 'set.gaSourceClear': 'Use bundled version', 'set.gaSourceCurrent': 'Connected to', 'set.serviceManager': 'Service manager',
    ...
    'set.openTempDirTip': 'Open the temp directory for reports, model responses, and temporary outputs',
    'set.openMemoryDirTip': 'Open the memory directory to view or edit memory files',
    'set.openAssetsDirTip': 'Open the assets directory for runtime assets and materials',
    'set.openRuntimeDirTip': 'Open the current GenericAgent runtime directory',
    ...
    'err.openDataDir': 'Failed to open folder',
